...
public:
    ...
    static ExprValue ExprValue::opSub(const Spectrum& speccy, const ExprValue& a, const ExprValue& b);
...
public:
    ...
    optional<ExprValue> parseExpression(Lex& lex, ErrorManager& errs, const Spectrum& speccy, const Lex::Element*& e, MemAddr currentAddress);
...
private:
    ...
    optional<ExprValue> eval(Lex& lex, ErrorManager& errs, const Spectrum& speccy, MemAddr currentAddress, Expression& expr);
