...
public:
    ...
    optional<ExprValue> parseExpression(Lex& lex, vector<ErrorInfo>& messages, const Lex::Element*& e, MemAddr currentAddress);
...
private:
    ...
    optional<ExprValue> eval(Lex& lex, vector<ErrorInfo>& messages, MemAddr currentAddress, Expression& expr);
